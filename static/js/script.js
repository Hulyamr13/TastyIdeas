...
function bookmarkActions(bookmarkBtn) {
    ...
    const url = isSaved ? `/api/tasty/bookmarks/${recipeId}/` : '/api/tasty/bookmarks/';
...
function showMoreCategories() {
    ...
    const url = `/api/tasty/categories/?page=${page}`;
    const requestOptions = {
        'method': 'GET',
        'headers': {
...
function showMoreComments() {
    ...
    const url = `/api/tasty/comments/?page=${page}&recipe_id=${recipeId}`;
    const requestOptions = {
        'method': 'GET',
        'headers': {
            'Content-Type': 'application/json',
